...
Cypress.Commands.add('login', (
    ...
    const login = () => {
        ...
        cy.contains('h1', 'Your Notes', {timeout:20000}).should('be.visible');
    };
...
Cypress.Commands.add('editNote', (note, newValue, attachFile = false) => {
    ...
    cy.contains('.list-group-item', note, {timeout:20000}).should('not.exist');
    cy.contains('.list-group-item', newValue, {timeout:20000}).should('be.visible');
});
